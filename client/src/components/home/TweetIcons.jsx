...
const TweetIcons = ({ handleChange }) => {
  return (
    <>
      <Form.Group controlId="formFile" className="position-relative overflow-hidden">
        <svg className="asd" viewBox="0 0 24 24" aria-hidden="true">
          <g>
        ...
        <div className="position-absolute opacity-0 top-0 right-0">
          <TweetInput type="file" accept="image/*" name="file" />

          {/* <Form.Control type="file" accept="image/*" onChange={handleChange} name="file" /> */}
        </div>
      </Form.Group>
      <Form.Group controlId="formFile" className=" position-relative overflow-hidden">
        <svg className="asd" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <Form.Control
          className="position-absolute opacity-0 top-0 right-0"
          type="file"
          accept="image/*"
